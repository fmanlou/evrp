...
DEFINE_string(log_level, "info",
              "evrp-client log level: error|warn|info|debug|trace.");
DEFINE_bool(
    wait_leading, true,
...
std::vector<evrp::sdk::DeviceKind> kindsFromKindFlag() {
...
void printUsage(const char* prog) {
  ...
  std::cout
      ...
      << "  --playback=FILE / -p FILE: playback; events or Lua (.lua).\n"
      << "  --output=FILE / -o FILE: write recording to FILE (default: stdout).\n"
      << "  --log_level=LEVEL / --log-level=LEVEL: client logging "
